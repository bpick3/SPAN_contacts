WITH myv_contacts AS (
  ...
  WHERE EXTRACT(YEAR FROM ccmyv.datetime_canvassed) IN (2016, 2020, 2022, 2024)
    ...
    AND ccmyv.committee_id IN ('54746', '81204', '91632', '101249', '107800', '107801') -- Filter by appropriate committees
  ...
  LEFT JOIN `democrats.vansync_ref.results` r ON r.result_id = ccmyv.result_id 
  WHERE EXTRACT(YEAR FROM ccmyv.datetime_canvassed) IN (2016, 2020, 2022, 2024)
    AND EXTRACT(MONTH FROM ccmyv.datetime_canvassed) = 8
    AND ccmyv.committee_id IN ('54746', '81204', '91632', '101249', '107800', '107801')
...
august_metrics AS (
  SELECT 
    ...
    state_code,
    COUNT(DISTINCT CASE WHEN contact_type_name IN ('Phone', 'Distributed Call', 'Auto Dial') AND committee_id IN ('54746', '81204', '91632', '107800') THEN contacts_contact_id ELSE NULL END) AS non_paid_phones,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Call' AND committee_id IN ('101249', '107801') THEN contacts_contact_id ELSE NULL END) AS paid_phones,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Walk' AND committee_id IN ('54746', '81204', '91632', '107800') THEN contacts_contact_id ELSE NULL END) AS non_paid_doors,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Walk' AND committee_id IN ('101249', '107801') THEN contacts_contact_id ELSE NULL END) AS paid_doors,
...
cycle_to_date_metrics AS (
  SELECT 
    '2024_CTD' AS cycle,
    state_code,
    COUNT(DISTINCT CASE WHEN contact_type_name IN ('Phone', 'Distributed Call', 'Auto Dial') AND committee_id = '107800' THEN contacts_contact_id ELSE NULL END) AS non_paid_phones,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Call' AND committee_id = '107801' THEN contacts_contact_id ELSE NULL END) AS paid_phones,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Walk' AND committee_id = '107800' THEN contacts_contact_id ELSE NULL END) AS non_paid_doors,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Walk' AND committee_id = '107801' THEN contacts_contact_id ELSE NULL END) AS paid_doors,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'SMS Text' THEN contacts_contact_id ELSE NULL END) AS total_text
  FROM myv_contacts
  ...
  SELECT 
    '2022_CTD' AS cycle,
    state_code,
    COUNT(DISTINCT CASE WHEN contact_type_name IN ('Phone', 'Distributed Call', 'Auto Dial') AND committee_id = '91632' THEN contacts_contact_id ELSE NULL END) AS non_paid_phones,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Call' AND committee_id = '101249' THEN contacts_contact_id ELSE NULL END) AS paid_phones,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Walk' AND committee_id = '91632' THEN contacts_contact_id ELSE NULL END) AS non_paid_doors,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Walk' AND committee_id = '101249' THEN contacts_contact_id ELSE NULL END) AS paid_doors,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'SMS Text' THEN contacts_contact_id ELSE NULL END) AS total_text
  FROM myv_contacts
  ...
  SELECT 
    '2020_CTD' AS cycle,
    state_code,
    COUNT(DISTINCT CASE WHEN contact_type_name IN ('Phone', 'Distributed Call', 'Auto Dial') AND committee_id = '81204' THEN contacts_contact_id ELSE NULL END) AS non_paid_phones,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Call' THEN contacts_contact_id ELSE NULL END) AS paid_phones, -- No 2020 Paid Committee
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Walk' AND committee_id = '81204' THEN contacts_contact_id ELSE NULL END) AS non_paid_doors,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Walk' THEN contacts_contact_id ELSE NULL END) AS paid_doors, -- No 2020 Paid Committee
    COUNT(DISTINCT CASE WHEN contact_type_name = 'SMS Text' THEN contacts_contact_id ELSE NULL END) AS total_text
  FROM myv_contacts
  ...
  SELECT 
    '2016_CTD' AS cycle,
    state_code,
    COUNT(DISTINCT CASE WHEN contact_type_name IN ('Phone', 'Distributed Call', 'Auto Dial') AND committee_id = '54746' THEN contacts_contact_id ELSE NULL END) AS non_paid_phones,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Call' THEN contacts_contact_id ELSE NULL END) AS paid_phones, -- No 2016 Paid Committee
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Walk' AND committee_id = '54746' THEN contacts_contact_id ELSE NULL END) AS non_paid_doors,
    COUNT(DISTINCT CASE WHEN contact_type_name = 'Paid Walk' THEN contacts_contact_id ELSE NULL END) AS paid_doors, -- No 2016 Paid Committee
    COUNT(DISTINCT CASE WHEN contact_type_name = 'SMS Text' THEN contacts_contact_id ELSE NULL END) AS total_text
  FROM myv_contacts
